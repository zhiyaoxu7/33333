...
if __name__ == '__main__':
    tf.app.flags.DEFINE_string("output_dir", r"F:\\pycharmworkingspace\\Unet\\data\\output",
                               "checkpoint and summary directory.")
    tf.app.flags.DEFINE_string("phase", "test",
                               "model phase: train/test.")
    tf.app.flags.DEFINE_string("training_set", r"F:\\pycharmworkingspace\\Unet\\datasets\\tfrecords",
                               "dataset path for training.")
    tf.app.flags.DEFINE_string("testing_set", r"F:\\pycharmworkingspace\\Unet\\data\\datasets\\test",
    ...
    tf.app.flags.DEFINE_integer("checkpoint_steps", 50,
                                "checkpoint period.")
    tf.app.flags.DEFINE_integer("save_steps", 50,
                                "checkpoint period.")
